...
@section('title', \App\CPU\translate('Agent List'))
                                    ...
                                    <table style="text-align: left;"
                                        ...
                                        <tbody>
                                            <tr v-for="(item, index) in lists" :key="item.id">
                                                <td>@{{ index + 1 }}</td>
                                                <td> <img style="width:120px;heigth:120px;" v-bind:src="item.agent_info.image"
                    ...
                    <div class="modal-body">
                        <form @submit.prevent="updateAgent()">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input type="file" ref="fileInput" v-on:change="onImageUpdate" name="image"
                                        accept="image/*" onchange="loadFiles(event)" class="form-control" >
                                </div>
                                <div class="col">
                            ...
                            <div class="row mt-4">
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control mt-2" id="agent_id"
                                        v-model="editData.agent_Autostring_id" placeholder="# AG123"  readonly/>
                                </div>
                                <div class="col">
                                    <label for="name">Name</label>
                                    <input type="text" class="form-control mt-2" id="name"
                                        v-model="editData.name"placeholder="Full Name" />
                                </div>

                                <div class="col">
                                    <label for="phone_one">Mobile Number 1</label>
                                    <input type="tel" class="form-control mt-2" id="phone_one"
                                        v-model="editData.mobileNumber1" placeholder="+8801754XXXXXX">
                                </div>
                            </div>
                            <div class="row mt-4">
                                <div class="col">
                                    <label for="phone_two">Mobile Number 2</label>
                                    <input type="tel" class="form-control mt-2" id="phone_two"
                                        v-model="editData.mobileNumber2" placeholder="+8801854XXXXXX">
                                </div>
                                <div class="col">
                                    <label for="name"> Zone Area</label>
                                    <select v-model="editData.agent_zone_area" id="" class="form-control  mt-2">
                                        <option value="" selected disabled>Select Zone Area</option>
                                        <option v-for="item in districts" :value="item.name">@{{ item.name }}
                                        </option>
                                    </select>
                                ...
                                <div class="col">
                                    <label for="division">Division</label>
                                    <select v-model="editData.agent_division" id="" class="form-control  mt-2">
                                        <option value="" selected disabled>Select Division</option>
                                        <option v-for="item in divisions" :value="item.name">@{{ item.name }}
                                        </option>
                                    </select>
                            ...
                            <div class="row mt-4">
                                <div class="col">
                                    <label for="present_address">Present Address</label>
                                    <textarea v-model="editData.present_address" class="form-control mt-2" cols="37" rows="2"></textarea>
                                </div>
                                <div class="col">
                                    <div class="col">
                                        <label for="permanent_address">Permanent Address</label>
                                        <textarea v-model="editData.permanent_address" id="permanent_address" class="form-control mt-2" cols="37"
                                            rows="2" placeholder="Permanent Address"></textarea>
                                    </div>
                                </div>
                                <div class="col"></div>
                            ...
                            <div class="row mt-4">
                                ...
                                {{-- <div class="col">
                                    <label for="bank_details">Bank Name</label>
                                    <select v-model="form.bank_name" id="" class="form-control  mt-2">
                                        <option value="" selected disabled>Select Bank</option>
                                        <option v-for="item in bank" :value="item.id">@{{ item.full_name }}
                                        </option>
                                ...
                                <div class="col">
                                    <label for="account_number" class="mt-2">Bank Name</label>
                                    <input type="text" class="form-control mt-2" id="account_number"
                                        v-model="editData.bank_name" placeholder="" />
                                </div>

                                <div class="col">
                                    <label for="account_number" class="mt-2">Account Number</label>
                                    <input type="number" class="form-control mt-2" id="account_number"
                                        v-model="editData.account_number" placeholder="Account Number" />
                                </div>
                                <div class="col">
                                    <label for="mobile_banking" class="mt-2">Mobile Banking</label>
                                    <input type="text" class="form-control mt-2" id="mobile_banking"
                                        v-model="editData.Mobile_banking" placeholder="Mobile Banking">
                                </div>
                                <div class="col">
                                    <label for="phone" class="mt-2">Banking Mobile Number </label>
                                    <input type="tel" class="form-control mt-2" id="phone"
                                        v-model="editData.banking_mobile_number" placeholder="+8801754XXXXXX">
                                </div>
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-3">
                                    <label for="email_two" class="mt-2">Email</label>
                                    <input type="email" class="form-control mt-2" id="email_two" v-model="editData.email"
                                        placeholder="Email" />
                                </div>
                                <div class="col-3">
                                    <label for="password" class="mt-2">Password</label>
                                    <input type="password" class="form-control mt-2" id="password"
                                        v-model="editData.password" placeholder="Password" />
                                </div>
                                <div class="col-3"></div>
                                <div class="col-3"></div>
...
<script>
    const app = new Vue({
        ...
        methods: { 
            ...
            view() {
                axios.get("/agent/agent/getAgentData")
                    .then(response => {
            ...
            onImageChange(e) {
             ...
             onImageUpdate(e) {
                    ...
                    saveAgent() {
                        ...
                        axios
                            .post("/agent/agent/store_agent_data/",formData )
                            .then(() => {
                                Swal.fire({
                                    position: 'top-end',
                                    icon: 'success',
                    ...
                    edit(agent_id) {
                        ...
                        //     }
                        // } .agent
                        axios.get(`/agent/agent/edit/${agent_id}`)
                            .then(response => {
                                // this.editData=response.data.agent;
                                
                                agent = response.data.agent;
                                this.editData.id = agent.id;
                                //  this.editData.image = agent.image;
                                this.editData.registration_date = agent.agent_info.registration_date;
                                this.editData.agent_Autostring_id = agent.agent_info.agent_Autostring_id;
                                this.editData.mobileNumber1 = agent.agent_info.mobileNumber1;
                                this.editData.mobileNumber2 = agent.agent_info.mobileNumber2;
                                this.editData.agent_zone_area = agent.agent_info.agent_zone_area;
                                this.editData.agent_division = agent.agent_info.agent_division;
                                this.editData.present_address = agent.agent_info.present_address;
                                this.editData.permanent_address = agent.agent_info.permanent_address;
                                this.editData.bank_name = agent.payment_details.bank_name.full_name;
                                this.editData.account_number = agent.payment_details.account_number;
                                this.editData.Mobile_banking = agent.payment_details.Mobile_banking;
                                this.editData.banking_mobile_number = agent.payment_details.banking_mobile_number;
                                this.editData.name = agent.name;
                                this.editData.email = agent.email;
                                this.editData.password = agent.password;
                    ...
                    updateAgent(){
                                    ...
                                    var editFData = new FormData();
                                    console.log(agent_id);
                                    Object.entries(this.editData).forEach(([key, value]) => {
                                    editFData.append(key, value);
                                     });
                                    axios
                                    .post(`/agent/agent/update/${this.editData.id}`,editFData)
                                    .then(response=>{
                                         this.view();
                                    })
                                },
                    deleteagent(agent_id) {
                                ...
                                Swal.fire({
                                    ...
                                    if (result.isConfirmed) {
                                        ...
                                        axios.get(`/agent/agent/remove/${agent_id}`)
                                            .then(response => {
